...
def main():
    ...
    This function sets up multiprocessing for cross-platform compatibility, launches both servers in their own processes, and monitors their status. If either server exits unexpectedly or a shutdown signal is received, it terminates both processes to ensure a clean shutdown.
    """
