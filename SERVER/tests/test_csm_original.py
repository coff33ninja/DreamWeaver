# Basic test for CSM process_story
    ...
    async def test_csm_process_story():
        ...
        This test verifies the integration of narration processing, character response generation, client communication, and database character retrieval by mocking their respective methods. It requires a dummy audio file and prints the resulting narration and character responses after processing. All mocks are restored and the CSM instance is shut down at the end of the test.
        """
        ...
        async def mock_narrator_process(audio_filepath):
            """
            Simulate narration processing by returning a fixed narration result for the given audio file path.
        ...
        async def mock_cs_gen_response(narration, other_texts):
            ...
            Parameters:
                ...
                other_texts (Any): Additional context or text inputs.
            
            Returns:
                str: A fixed asynchronous character response.
            """
        ...
        def mock_db_get_char(Actor_id):
            ...
            Parameters:
                Actor_id (str): The ID of the actor to retrieve.
