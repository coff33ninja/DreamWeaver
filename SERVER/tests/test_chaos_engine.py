...
class TestChaosEngine(unittest.TestCase):
    def setUp(self):
        ...
        self.test_char_texts = {"Alice": "I hope we find the treasure.", "Bob": "Watch out for traps!"}
    ...
    def test_no_major_event_demo_key(self, mock_random):
        ...
        updated_narration, updated_char_texts = self.chaos_engine.apply_chaos(self.test_narration, self.test_char_texts.copy())
    ...
    def test_minor_text_chaos_scramble(self, mock_random):
        ...
        mock_random.side_effect = [0.2, 0.04, 0.4]  # Trigger minor chaos and scramble text
        updated_narration, updated_char_texts = self.chaos_engine.apply_chaos(self.test_narration, self.test_char_texts.copy())
    ...
    def test_minor_text_chaos_shout(self, mock_random):
        ...
        updated_narration, updated_char_texts = self.chaos_engine.apply_chaos(self.test_narration, self.test_char_texts.copy())
        self.assertEqual(updated_char_texts["Alice"], self.test_char_texts["Alice"].upper() + "!!")
        self.assertEqual(updated_char_texts["Bob"], self.test_char_texts["Bob"].upper() + "!!")
