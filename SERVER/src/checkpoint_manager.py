...
class CheckpointManager:
    ...
    def save_checkpoint(self, name_prefix=""):
        ...
        Parameters:
            name_prefix (str): Optional prefix for the checkpoint directory name.
    ...
    def load_checkpoint(self, checkpoint_name):
        ...
        Returns:
        	str: A message indicating success and the need to restart the application, or an error message if the checkpoint or required files are missing.
        """
        checkpoint_dir = os.path.join(BASE_CHECKPOINT_PATH, checkpoint_name)
    ...
    def export_story(self, export_format="text"):
        ...
        Returns:
            tuple: A tuple containing a status message and the export filename (or None if export failed).
        """
