...
class CheckpointManager:
    ...
    def list_checkpoints(self):
        ...
        Returns:
            list: A list of checkpoint directory names, or an empty list if the checkpoint directory does not exist.
        """
        try:
    ...
    def save_checkpoint(self, name_prefix=""):
        ...
        Returns:
            tuple: A message indicating success or error, and a list of available checkpoint names.
        """
    ...
    def export_story(self, export_format="text"):
        ...
        Returns:
            tuple: A message indicating success or error, and the export filename if successful, otherwise None.
        """
