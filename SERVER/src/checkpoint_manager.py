...
class CheckpointManager:
    ...
    def list_checkpoints(self):
        ...
        Returns:
            List of checkpoint directory names, or an empty list if no checkpoints exist.
        """
        try:
    ...
    def load_checkpoint(self, checkpoint_name):
        """
        Restore the database and server adapter files from a specified checkpoint.
    ...
    def export_story(self, export_format="text"):
        ...
        Returns:
            tuple: A message indicating success or error, and the filename if successful, otherwise None.
        """
