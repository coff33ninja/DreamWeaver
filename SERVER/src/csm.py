...
class CSM:
    def __init__(self):
        """
        Initializes the CSM instance and its core components, including database, narrator, character server, client manager, hardware interface, and chaos engine. Starts periodic health checks for connected clients.
        """
    ...
    async def process_story(self, audio_filepath: str, chaos_level: float):
        """
        Asynchronously processes a story turn by generating narration, collecting character responses from both the server and online clients, optionally applying chaos effects, updating hardware, and saving the results to the database.
        ...
        Returns:
            ...
            character_texts (dict): A dictionary mapping character names to their response texts for this story turn.
        """
