...
class CSM:
    def __init__(self):
        """
        Initialize the CSM instance and its core components, including database, narrator, character server, client manager, hardware, and chaos engine. Starts periodic client health checks upon initialization.
        """
    ...
    async def process_story(self, audio_filepath: str, chaos_level: float):
        """
        Asynchronously processes a story turn by generating narration, collecting responses from the server character and all responsive clients, optionally applying chaos effects, updating hardware, and saving the results to the database.
        ...
        Returns:
            ...
            character_texts (dict): A mapping of character names to their response texts for this story turn.
        """
    ...
    async def shutdown_async(self): # Renamed for clarity
        """
        Asynchronously shuts down CSM resources, stopping client health checks and closing the database connection.
        """
