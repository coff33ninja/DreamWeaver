...
def save_env_vars(new_vars_str: str):
    ...
    Each variable assignment should be on a separate line in the format `KEY=VALUE`. Existing variables are updated, and new ones are added. Returns a success message if the operation completes, or an error message if an exception occurs.
    """
    try:
