...
def ensure_client_directories():
    """
    Ensure that all required client directories exist, creating them if necessary.
    
    If a directory cannot be created due to an OS error, an error message is printed indicating the problematic path and the exception encountered.
    """
    paths_to_create = [
        CLIENT_DATA_PATH,
        CLIENT_MODELS_PATH,
