...
def main():
    ...
    Initializes the character client instance, starts a heartbeat background task if initialization succeeds, and runs the FastAPI server using the specified host and port. If required configuration (such as the authentication token) is missing or initialization fails, the server does not start.
    """
