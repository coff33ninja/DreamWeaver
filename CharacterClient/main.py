...
def main():
    ...
    This function configures the client using command-line options or environment variables, validates required parameters, initializes the character client instance, starts a heartbeat background task if initialization succeeds, and launches the FastAPI app server. If initialization fails or a required token is missing, the server does not start.
    """
