    ...
    def test_pagination_workflow(self, character_client):
        ...
        with patch("requests.Session.get") as mock_get:
            ...
            page1_response.json.return_value = {
                "characters": [
                    {"id": i, "name": f"Character {i}"} for i in range(1, 6)
                ],
                "total": 12,
                "limit": 5,
                "offset": 0,
            ...
            page2_response.json.return_value = {
                "characters": [
                    {"id": i, "name": f"Character {i}"} for i in range(6, 11)
                ],
                "total": 12,
                "limit": 5,
                "offset": 5,
            ...
            page3_response.json.return_value = {
                "characters": [
                    {"id": i, "name": f"Character {i}"} for i in range(11, 13)
                ],
                "total": 12,
                "limit": 5,
                "offset": 10,
            ...
            all_characters = (
                page1["characters"] + page2["characters"] + page3["characters"]
            )
